...
/**
 * @file    CInBriding.h
 * @brief   Файл содержит класс CInBriding отбора родительских хромосом
 * @date    20/02/2009
**/
...
{
    struct CInBriding : virtual public IGrouping
    {
        /**
        ...
        **/
        const QString name()
        {
            return QObject::trUtf8("Инбридинг (группировка близких хромосом)");
        };
    };
};
